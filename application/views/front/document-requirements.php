...
.details_info ol h5, .details_info ol p, .details_info ol ul {
    padding-left: 20px;
}
...
.final_notes p.print_page {
    margin: 0;
    color: red;
    font-weight: 600;
}
.details_info ol ul li {
    text-transform: none;
}
.final_notes p {
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="details_info">
                            <h4>procedures at witnessing facility</h4>
                            <p>Note: After meeting the requirements listed above, the US State Department requiresyou must present yourself in person (or as a parent applying for a minor) at a Witnessing Facility and have your identity verified and signature witnessed by a Witnessing Facility.  Normally this is a specific Post Office or Country Clerk.  See details as listed below:</p>
                            <ol>
                                <li>make appointment at witnessing facility<br/>
                                    <h5>Locate Facility</h5>
                                    <p>all applicants must appear in person for the witnessing.</p>
                                    <ul>
                                        <li>If applicant is a minor under the age of 16, the minor must appear along with both parents.  Note: if only one parent can attend the witnessing the government allows for the absent parent to submit a Notarized form <a href="https://eforms.state.gov/Forms/ds3053.pdf">DS-3053</a> in lieu of their attendance along with a clear color copy of their Drivers License.</li>
                                        <li>Ifapplicant is between the ages of 16 and 18 years old, only one parent must appear for witnessing.</li>
                                    </ul>
                                </li>
                                <li>assemble all requirements as listed in requirement section</li>
                                <li>personally appear at post office for witnessing of signature</li>
                                <li>review final notes page once you have finished at the post office</li>
                                <li>Download the attached Pre-Paid FedEx airbill and use it to ship to us your documents</li>
                                <li>Drop your package at a FedEx location.  For a list of locations <a href="https://local.fedex.com/en-us">click here</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="final_notes">
                            <p>List of Documents to take with you: (per person)</p>
                            <ol>
                                <li>Proof of Citizenship</li>
                                <li>All application completed but NOT SIGNED</li>
                                <li>Letter of Authorization form (SIGNED)</li>
                                <li>Passport Photograph</li>
                                <li>Evidence of Identification</li>
                                <li>Proof of departure</li>
                                <li>Government Fees</li>
                                <li>Envelope: 9x12 plain envelope</li>
                            </ol>
                        </div>
                    </div>
                </div>
